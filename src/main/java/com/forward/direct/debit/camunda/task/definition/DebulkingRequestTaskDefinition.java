...
import com.forward.direct.debit.camunda.model.DebulkingPain008Request;
...
public class DebulkingRequestTaskDefinition extends ServiceTaskDefinition{
    ...
    public void execute() throws Exception {
        ...
        // create payload as DebulkingPain008Request
        ...
        String payload = OBJECT_MAPPER.writeValueAsString(
                new DebulkingPain008Request(123456, 7890123, paymentXmlPath)
        );
    ...
    private void sendToQueue(String payload, String correlationId) throws JMSException {
        ...
        final String debulkingQueueName = "FILE.PROCESS.SERVICE.REQUEST.QUEUE";
        ...
        try {
            ...
            Queue queue = session.createQueue(debulkingQueueName);
            producer = session.createProducer(queue);
            TextMessage message = session.createTextMessage(payload);
            message.setJMSCorrelationID(correlationId);
            producer.send(message);
            System.out.println("✓ Message sent to " + debulkingQueueName);
