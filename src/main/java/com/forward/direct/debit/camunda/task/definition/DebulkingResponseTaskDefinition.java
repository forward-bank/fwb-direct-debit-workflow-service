...
public class DebulkingResponseTaskDefinition extends MessageReceiveTaskDefinition{

    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();

    public DebulkingResponseTaskDefinition(ExecutionContext executionContext) {
    ...
    public void execute(Message message) throws Exception {
        ...
        System.out.println("DebulkingResponseTaskDefinition Executing Debulking Response Task...");
